    ...
    clear(expResult).append(
      ...
      el('div.panel.caution', { style: { marginTop: '16px' } }, [
        ...
        el('ul.small', { style: { margin: 0, paddingLeft: '20px' } }, [
          ...
          el('li', { html: '말하는 것: <b>표본이 적은 규칙일수록 크게 튑니다.</b> 검출이 몇십 건뿐인 규칙은 여기서도 기준선에서 10%p 넘게 벌어지곤 합니다. 순전한 우연이 그렇게 보인다는 뜻이니, 실제 데이터에서도 표본이 적은 승률은 그만큼 믿지 마세요. 위 표에서 검출 건수와 승률을 같이 보세요.' }),
